...
int main(int argc, char* argv[]) {
	if(argc < 2) {
        cout << "Usage: ./FusionCluster [options] -FusionFile <Output from Fusion Program> -ClusterFile1 <MetaCluster file from SOM1> -ClusterFile2 <MetaCluster file from SOM2> -Output <Output File Location>" <<endl;
        return 0;
    }
	string infilename;
